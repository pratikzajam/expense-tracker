...
const EditTransaction = ({ transactionId, transactionType, category, date, amount, description }) => {

  const [open, setOpen] = useState(false);

  const [form, setForm] = useState({transaction_id:"",transaction_type: "", category: "", date: "", amount: null, Description: "" })
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
            Edit your transaction details below and click save when you're done.
            </DialogDescription>
          </DialogHeader>
